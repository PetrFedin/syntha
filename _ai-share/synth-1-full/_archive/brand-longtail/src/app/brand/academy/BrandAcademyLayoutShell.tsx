...
type BrandAcademyLayoutShellProps = {
  children: ReactNode;
};

/** Академия бренда: KPI, tabs, brand-academy-data — отдельный chunk от `academy/layout.tsx`. */
export function BrandAcademyLayoutShell({ children }: BrandAcademyLayoutShellProps) {
