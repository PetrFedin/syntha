    ...
    <div className="space-y-4">
      ...
      {overviewSubTab === 'analytics' && (
        <div className="space-y-4">
          ...
          <div className="border-border-subtle bg-bg-surface2 flex items-center justify-between rounded-xl border p-2 shadow-inner">
            ...
            <div className="border-border-subtle bg-bg-surface flex shrink-0 rounded-lg border p-0.5 shadow-sm">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button className="text-text-muted hover:text-text-primary h-6 rounded-md px-2 transition-all">
                    <Calendar className="h-3 w-3" />
                  </button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="end">
                  <div className="text-text-muted p-4 text-[9px] font-bold uppercase italic tracking-widest">
                    Temporal Selection...
                  </div>
                </PopoverContent>
              </Popover>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3 lg:grid-cols-5">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-lg">
                ...
                <div className="mt-6 space-y-6">
                  <div className="border-border-subtle from-accent-primary/10 to-bg-surface2 relative overflow-hidden rounded-2xl border bg-gradient-to-br p-3">
                    <div className="relative z-10">
                      ...
                      <div className="bg-bg-surface2 mb-4 h-3 w-full overflow-hidden rounded-full">
                        <div className="bg-accent-primary h-full w-[85%] rounded-full shadow-[0_0_10px_rgba(0,0,0,0.08)]" />
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <div className="flex cursor-pointer items-center justify-between rounded-lg border bg-background p-3 transition-colors hover:border-blue-200">
                        <div className="flex items-center gap-3">
                          <Palette className="text-accent-primary h-4 w-4" />
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-12">
            ...
            <Card className="flex h-full flex-col lg:col-span-7">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-sm">
                  <Search className="text-accent-primary h-5 w-5" />
      ...
      {overviewSubTab === 'recommendations' && (
        <div className="space-y-4">
          <div className="border-border-subtle bg-bg-surface2 flex flex-col items-start justify-between gap-3 rounded-xl border p-1 shadow-inner md:flex-row md:items-center">
            <div className="border-border-subtle bg-bg-surface flex rounded-lg border p-0.5 shadow-sm">
              <button
            ...
            <div className="flex shrink-0 gap-1.5 px-1">
              <select
                className="border-border-subtle bg-bg-surface text-text-secondary focus:ring-accent-primary/30 h-7 rounded-lg border px-2.5 text-[9px] font-bold uppercase tracking-widest shadow-sm outline-none transition-all focus:ring-1"
