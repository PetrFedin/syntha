...
export function ProfilePreferences({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-border-subtle bg-text-primary text-text-inverse relative overflow-hidden rounded-xl border shadow-xl">
        ...
        <CardContent className="relative z-10 space-y-4 p-4 pt-0">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
              ...
              {syncedChannels.includes('telegram') ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="text-accent-primary hover:text-text-inverse flex items-center gap-2 text-[9px] font-black uppercase underline decoration-2 underline-offset-4 transition-colors"
                  >
                    {isSyncing === 'telegram' ? (
                      <>
            ...
            <div className="border-accent-primary/30 bg-accent-primary/15 space-y-4 rounded-2xl border p-3">
              <div className="text-text-inverse/80 flex items-center gap-2 text-[9px] font-black uppercase">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Badge className="bg-accent-primary text-text-inverse border-none font-black">
                82 / 100
              </Badge>
            </div>
            <div className="h-2 overflow-hidden rounded-full bg-white/10">
              <div className="from-accent-primary via-accent-primary/80 to-accent-primary/50 h-full w-[82%] bg-gradient-to-r" />
            </div>
