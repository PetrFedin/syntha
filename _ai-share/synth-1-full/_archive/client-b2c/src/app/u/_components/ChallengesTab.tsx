...
export function ChallengesTab() {
  ...
  return (
    <div className="space-y-10 pb-10 duration-500 animate-in fade-in">
      ...
      <Card className="group/banner relative flex min-h-[400px] items-center overflow-hidden rounded-xl border-none bg-slate-900 shadow-2xl">
        ...
        <CardContent className="relative z-10 w-full max-w-4xl space-y-4 p-4 text-white">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-xl border-l-2 border-amber-500/50 pl-6 text-sm font-medium italic leading-relaxed text-slate-300">
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-end justify-between gap-3 md:flex-row">
              <div className="space-y-2">
                ...
                <p className="max-w-md font-medium text-slate-400">
            ...
            {step === 'browse' ? (
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      selectedLookId === lb.id
                        ? 'scale-95 border-slate-900 shadow-2xl'
                        : 'border-transparent bg-[#fcfcfc]'
                    )}
                  >
                    <img
                      src={
                    ...
                    {selectedLookId === lb.id && (
                      <div className="absolute right-6 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-slate-900 text-white shadow-xl duration-300 animate-in zoom-in">
              ...
              <div className="flex flex-col items-center space-y-4 rounded-xl border border-dashed border-slate-200 bg-white p-4 text-center shadow-sm">
                ...
                <div className="flex gap-3">
                  <Button className="button-glimmer h-10 rounded-2xl bg-black px-10 text-[11px] font-black uppercase tracking-widest text-white shadow-xl">
                    Выбрать файл
                  </Button>
                  <Button
                    variant="outline"
                    className="h-10 rounded-2xl border-2 border-slate-900 px-10 text-[11px] font-black uppercase tracking-widest text-slate-900"
                  >
          ...
          <Card className="space-y-6 rounded-xl border bg-white p-4 shadow-sm">
            ...
            <div className="space-y-4">
              {pastChallenges.map((c) => (
                <div
                  key={c.id}
                  className="group flex cursor-default items-center justify-between rounded-2xl border border-slate-100 bg-slate-50 p-4 transition-colors hover:border-slate-900"
                >
