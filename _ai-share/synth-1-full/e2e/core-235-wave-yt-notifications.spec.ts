...
/**
 * Wave YT S4: notification center compact on all role pillar cards + calendar/tracking → detail CTA.
 * PLAYWRIGHT_SKIP_WEBSERVER=1 npm run test:e2e:core -- e2e/core-235-wave-yt-notifications.spec.ts
 */
test.describe('core-235: wave YT notification center final', () => {
  for (const roleCase of [
    { role: 'shop-dev', path: `/shop/core?pillar=development&collection=${COLLECTION}`, prefix: 'shop-cm' },
