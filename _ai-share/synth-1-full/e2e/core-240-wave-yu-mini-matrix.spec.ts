...
/**
 * Wave YU: brand SC 1.2 — one-click mini-matrix prefill polish + matrix CTA dedup.
 * PLAYWRIGHT_SKIP_WEBSERVER=1 npm run test:e2e:core -- e2e/core-240-wave-yu-mini-matrix.spec.ts
 */
test.describe('core-240: wave YU brand SC mini-matrix CTA', () => {
