...
export function BrandCoRegistryRetailOnboardingStrip({ collectionId, orderId }: Props) {
  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="brand-co-registry-retail-onboarding-strip">
      <Link
        href={crmHref}
        data-testid="brand-co-registry-crm-segments-link"
      ...
      <Link
        href={pricelistHref}
        data-testid="brand-co-registry-crm-pricelist-link"
        className={hubGadget.goldenLink}
      >
        Прайс-лист
      </Link>
      ...
      <Link
        href={session.showroomHref}
        data-testid="brand-co-registry-shop-showroom-link"
        className={hubGadget.goldenLink}
      >
        Shop showroom
      </Link>
      ...
      <Link
        ...
        data-testid="brand-co-registry-shop-checkout-link"
        className={hubGadget.goldenLink}
      >
        Оформление
      </Link>
