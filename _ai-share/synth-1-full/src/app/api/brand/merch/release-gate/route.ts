...
import { BRAND_RELEASE_GATE_PASSPORT_API_PATH } from '@/lib/production/brand-material-passport-release-gate';
...
/** POST — release gate: material passport must be complete before publish. */
    ...
    return NextResponse.json(
      {
        ...
        apiPath: BRAND_RELEASE_GATE_PASSPORT_API_PATH,
      },
