...
import { BrandInventoryOpsGoldenPathStrip } from '@/components/brand/inventory/BrandInventoryOpsGoldenPathStrip';
  ...
  return (
    ...
    >
      <div className="mb-4 space-y-3">
        <BrandInventoryOpsGoldenPathStrip collectionId={collectionId} orderId={orderId} />
      ...
      {activeFeatureId === 'overview' ? (
        <div className="space-y-4">
          ...
          <div className="border-border-subtle flex flex-wrap items-center justify-between gap-3 rounded-xl border bg-white p-4 shadow-sm">
            <div className="space-y-1">
              <p className="text-text-primary text-sm font-semibold">Матрица остатков бренда</p>
              <p className="text-text-secondary text-xs">
                Остатки, доступность и сверка с магазином остаются в одном контексте заказа и
                коллекции.
              </p>
            </div>
