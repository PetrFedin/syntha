              ...
              <div className="flex flex-wrap items-center gap-2">
                {opsStorageMode === 'postgres' ? (
                  <Badge
                    variant="outline"
                    className="text-[9px]"
                    data-testid="brand-production-ops-storage-pg"
                  >
                    PG
                  </Badge>
            ...
            <Tabs defaultValue="overview" className="space-y-4">
              ...
              <TabsContent value="articles" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                      Правила: на этап PO — только после утверждения Gold Sample и этапа
                      «Утверждение»; производство — после подтверждённого PO; склад — после
                      успешного QC (блокировка при fail/rework с флагом отгрузки).
                    </CardDescription>
                  </CardHeader>
              ...
              <TabsContent value="po" className="space-y-4">
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-sm">
                      <Factory className="h-4 w-4" aria-hidden /> PO → коллекция → артикулы →
                      размеры
                    </CardTitle>
                    <CardDescription className="text-xs">
                      Критический путь и риск срыва учитываются в алертах. Экспорт в Excel/CSV для
                      фабрики (подготовка к ERP).
                    </CardDescription>
                  </CardHeader>
              ...
              <TabsContent value="b2b" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                      Готовность к лайншиту/pre-order, остатки готовой продукции, заказы B2B по
                      коллекции (связь с артикулами).
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 text-xs">
                    <div>
                  ...
                  <CardContent className="max-w-lg space-y-3 text-xs">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setState(
                            updateIntegrationConfig(state, { erpExportEnabled: e.target.checked })
                          )
                        }
