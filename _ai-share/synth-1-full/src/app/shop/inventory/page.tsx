...
import { ShopInventoryOpsGoldenPathStrip } from '@/components/shop/inventory/ShopInventoryOpsGoldenPathStrip';
...
function ShopInventoryWorkspace() {
  ...
  return (
    ...
    >
      <div className="mb-4 space-y-3">
        <ShopInventoryOpsGoldenPathStrip collectionId={collectionId} orderId={orderId} />
...
export default function ShopInventoryPage() {
  const session = buildShopInventoryOpsSession();
        ...
        <Suspense fallback={null}>
          <div className="mb-2">
            <Button variant="ghost" size="sm" asChild>
              <Link href={session.replenishmentAtpHref}>
