  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="mfr-op-handoff-queue-co-spine-peer-strip">
      <Link
        ...
        data-testid="mfr-op-handoff-queue-brand-handoff-link"
      ...
      <Link
        ...
        data-testid="mfr-op-handoff-queue-shop-tracking-link"
        className={hubGadget.goldenLink}
      >
        Трекинг магазина
      </Link>
      ...
      <Link
        ...
        data-testid="mfr-op-handoff-queue-prod-orders-link"
        className={hubGadget.goldenLink}
      >
        Заказы на выпуск
      </Link>
      ...
      <Link
        ...
        data-testid="mfr-op-handoff-queue-techpack-ack-link"
        className={hubGadget.goldenLink}
      >
        Подтверждение ТЗ
      </Link>
      ...
      <Link
        ...
        data-testid="mfr-op-handoff-queue-cut-ticket-link"
        className={hubGadget.goldenLink}
      >
        Техкарта раскроя
      </Link>
      ...
      <Link
        ...
        data-testid="mfr-op-handoff-queue-shop-comms-link"
        className={hubGadget.goldenLink}
      >
        Чат с магазином
      </Link>
