...
import { BrandCoRegistryRetailOnboardingStrip as Archived } from '@/_archive/platform-core-legacy/components/platform/retail-crm/BrandCoRegistryRetailOnboardingStrip';
