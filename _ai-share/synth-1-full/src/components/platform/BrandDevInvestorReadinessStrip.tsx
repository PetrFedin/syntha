...
import { BrandDevInvestorReadinessStrip as Archived } from '@/_archive/platform-core-legacy/components/platform/monetization-mfr/BrandDevInvestorReadinessStrip';
