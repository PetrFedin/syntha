...
export function BrandDevW2HubCoPeerStrip({ collectionId, orderId }: Props) {
  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="brand-dev-w2-hub-co-peer-strip">
      <Link href={shop.matrixHref} data-testid="brand-dev-w2-hub-shop-matrix-link" className={hubGadget.goldenLink}>
        Матрица магазина
      </Link>
      <span className={hubGadget.goldenSep} aria-hidden>·</span>
      <Link href={shop.checkoutHref} data-testid="brand-dev-w2-hub-shop-checkout-link" className={hubGadget.goldenLink}>
        Оформление
      </Link>
      <span className={hubGadget.goldenSep} aria-hidden>·</span>
      ...
      <span className={hubGadget.goldenSep} aria-hidden>·</span>
      <Link href={shop.trackingHref} data-testid="brand-dev-w2-hub-shop-tracking-link" className={hubGadget.goldenLink}>
        Трекинг магазина
      </Link>
    </div>
  );
