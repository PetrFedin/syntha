  ...
  return (
    ...
    >
      <Link
        ...
        data-testid="brand-op-chain-handoff-link"
      ...
      <Link
        href={matrixHref}
        data-testid="brand-op-chain-shop-matrix-link"
        className={hubGadget.goldenLink}
      >
        Матрица магазина
      </Link>
      ...
      <Link
        href={checkoutHref}
        data-testid="brand-op-chain-shop-checkout-link"
        className={hubGadget.goldenLink}
      >
        Оформление
      </Link>
      ...
      <Link
        ...
        data-testid="brand-op-chain-shop-tracking-link"
        className={hubGadget.goldenLink}
      >
        Трекинг магазина
      </Link>
      ...
      <Link
        ...
        data-testid="brand-op-chain-mfr-comms-link"
        className={hubGadget.goldenLink}
      >
        Связь с цехом
      </Link>
