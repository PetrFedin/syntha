  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="brand-op-inventory-co-peer-strip">
      <Link
        ...
        data-testid="brand-op-inventory-handoff-link"
      ...
      <Link
        ...
        data-testid="brand-op-inventory-shop-tracking-link"
        className={hubGadget.goldenLink}
      >
        Трекинг магазина
      </Link>
      ...
      <Link
        href={inv.replenishmentAtpHref}
        data-testid="brand-op-inventory-replenishment-link"
        className={hubGadget.goldenLink}
      >
        Shop ATP
      </Link>
      ...
      <Link
        ...
        data-testid="brand-op-inventory-registry-link"
        className={hubGadget.goldenLink}
      >
        Реестр
      </Link>
