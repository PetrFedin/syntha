  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="shop-co-landed-margin-spine-peer-strip">
      <Link
        ...
        data-testid="shop-co-landed-margin-matrix-link"
      ...
      <Link
        href={checkoutHref}
        data-testid="shop-co-landed-margin-checkout-link"
        className={hubGadget.goldenLink}
      >
        Оформление
      </Link>
      ...
      <Link
        ...
        data-testid="shop-co-landed-margin-replenishment-link"
        className={hubGadget.goldenLink}
      >
        ATP
      </Link>
      ...
      <Link
        href={session.orderCommsHref}
        data-testid="shop-co-landed-margin-order-comms-link"
        className={hubGadget.goldenLink}
      >
        Чат по заказу
      </Link>
      ...
      <Link
        href={session.brandPricelistHref}
        data-testid="shop-co-landed-margin-brand-pricelist-link"
        className={hubGadget.goldenLink}
      >
        Прайс-лист бренда
      </Link>
      ...
      <Link
        ...
        data-testid="shop-co-landed-margin-collaborative-link"
        className={hubGadget.goldenLink}
      >
        Согласования
      </Link>
