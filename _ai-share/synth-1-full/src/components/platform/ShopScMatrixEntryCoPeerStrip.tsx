...
export function ShopScMatrixEntryCoPeerStrip({ collectionId, orderId }: Props) {
  ...
  return (
    <div
      ...
      data-testid={WAVE_YP_SHOP_SC_MATRIX_ENTRY_CO_PEER_STRIP_TESTID}
    >
      <Link
        href={session.hubHref}
        data-testid="shop-sc-matrix-entry-platform-hub-link"
      ...
      <Link
        ...
        data-testid="shop-sc-matrix-entry-collaborative-link"
        className={hubGadget.goldenLink}
      >
        Совместный заказ
      </Link>
      ...
      <Link
        ...
        data-testid="shop-sc-matrix-entry-replenishment-link"
        className={hubGadget.goldenLink}
      >
        ATP
      </Link>
