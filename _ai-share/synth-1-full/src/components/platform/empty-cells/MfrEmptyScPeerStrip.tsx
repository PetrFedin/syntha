  ...
  return (
    <div className={hubGadget.goldenPath} data-testid="mfr-empty-sc-peer-strip">
      <Link
        ...
        data-testid="mfr-empty-sc-shop-showroom-link"
      ...
      <Link
        ...
        data-testid="mfr-empty-sc-shop-matrix-link"
        className={hubGadget.goldenLink}
      >
        Матрица магазина
      </Link>
      ...
      <Link
        href={linesheetHref}
        data-testid="mfr-empty-sc-brand-linesheet-link"
        className={hubGadget.goldenLink}
      >
        Brand linesheet
      </Link>
      ...
      <Link
        ...
        data-testid="mfr-empty-sc-sample-queue-link"
        className={hubGadget.goldenLink}
      >
        Очередь образцов
      </Link>
