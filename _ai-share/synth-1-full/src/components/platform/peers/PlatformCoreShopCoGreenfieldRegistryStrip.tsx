...
/** Greenfield shop · cabinet CO registry (native matrix seed href). */
export function PlatformCoreShopCoGreenfieldRegistryStrip({ buyerId, collectionId }: Props) {
  ...
  const matrixHref = platformCoreUiHref(
    shopGreenfieldMatrixSeedHref({ collectionId, buyerId, state })
  );
