...
import { brandB2bOrderHandoffContextHref, brandB2bOrderHref, brandB2bOrdersProductionRegistryHref, brandMessagesB2bOrderContextHref, shopB2bTrackingOrderHref } from '@/lib/platform-core-routes';
import { factoryProductionDossierContextHref, factoryMessagesB2bOrderContextHref, factoryProductionOrdersOrderContextHref } from '@/lib/platform-core-extended-routes';
import {
...
export function OrderProductionPillarCardManufacturer({
  variant,
  compact = false,
  minimalChrome = false,
}: Props) {
