...
/**
 * Wave 44–48: 3D embed — iframe | sdk-stub | live SDK (native platform/showroom).
 */
import { useEffect, useRef, useState } from 'react';
import { loadShowroom3dProvider } from '@/components/platform/showroom/showroom-3d-providers/load-provider';
...
export function PlatformCoreShowroom3dStreamPanel({
  collectionId = 'SS27',
  ...
  useEffect(() => {
    ...
    if (embedMode === 'sdk' && payload.sdkConfig) {
      ...
      if (providerId === 'matterport' || providerId === 'generic') {
        void loadShowroom3dProvider(providerId).then((adapter) => {
