...
} from '@/lib/platform-core-ports/b2b/brand-sc-linesheet-readpath';
import type { ShopShowroomCoverHeroSource } from '@/lib/platform-core-ports/b2b/shop-showroom-cover-hero';
...
export function ShopShowroomCoverHeroPriorityStrip({ activeSource, className }: Props) {
  return (
    <p
      className={cn(hubGadget.muted, 'text-[10px] leading-snug', className)}
