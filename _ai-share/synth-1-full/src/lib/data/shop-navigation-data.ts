...
/** Плоские пункты верхнего уровня кабинета (legacy tabs + subsection helpers). */
export const mainShopNavLinks = shopNavGroups.flatMap((g) => g.links) as ShopNavLinkFlat[];
