...
function selectionLineForm(selection) {
  openForm('\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0438\u043b\u0438 \u043e\u0431\u043d\u043e\u0432\u0438\u0442\u044c SKU', [textDef('sku','SKU'), numberDef('quantity','\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e',1,true), numberDef('unitPrice','\u0426\u0435\u043d\u0430',0,false)], values => mutate(`/v2/selections/${encodeURIComponent(selection.id)}/lines/${encodeURIComponent(values.sku)}`, { selectionId: selection.id, sku: values.sku, quantity: values.quantity, unitPrice: values.unitPrice }, 'PUT'));
}
function orderForm() {
