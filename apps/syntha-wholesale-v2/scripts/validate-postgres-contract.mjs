...
const sql = await readFile(path.join(root, 'db/migrations/001_wholesale_v2.sql'), 'utf8');
...
console.log(`PostgreSQL contract OK (${requiredTables.length} tables checked).`);
